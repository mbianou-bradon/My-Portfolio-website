    ...
    return (
        <Link to={`/projects/${projectId}`}>
            <div className="h-[25rem] border border-tertiary rounded-lg overflow-hidden hover:-rotate-3 hover:scale-[1.04]">
                <div className="h-[75%] bg-tertiary overflow-hidden p-1">
                    <img src={props.project.images[0]} alt={props.project.title} className="h-full aspect-video object-center hover:scale-[1.03]"/>
                </div>
